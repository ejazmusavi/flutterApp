...
void main() => runApp(MaterialApp(home: GramPilotExplorer()));

class GramPilotExplorer extends StatefulWidget {
  @override
  _GramPilotExplorerState createState() => _GramPilotExplorerState();
}

class _GramPilotExplorerState extends State<GramPilotExplorer> {
        ...
        children: [
          Column(
            children: < Widget > [
              Expanded(
                  child: WebView(
                    initialUrl: 'https://grampilot.skillpatron.com',
          ...
          Container(
            color: Colors.white,
            child: Center(
              child: SpinKitFoldingCube(color: Colors.blue,size : 100.0),
            ),
          ),
        ],
      ),
        ...
        return PopupMenuButton<String>(
          onSelected: (String value) async {
            if (value == 'Email link') {
              var url = await controller.data.currentUrl();
              await launch(
                  'mailto:?subject=Check out this cool Application for your instagram account page&body=$url');
            } else {
